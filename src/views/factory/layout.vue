    ...
    <a-layout-sider v-model:collapsed="collapsed" collapsible>
      ...
      >
        <a-menu-item key="products">
          ...
          <span>产品管理</span>
          <router-link to="/factory/products" />
        </a-menu-item>
        <a-menu-item key="add-product">
          ...
          <span>添加产品</span>
          <router-link to="/factory/add-product" />
        </a-menu-item>
        <a-menu-item key="transfers">
          ...
          <span>交接记录</span>
          <router-link to="/factory/transfers" />
        </a-menu-item>
        <a-menu-item key="transfer-product">
          <template #icon>
            <SendOutlined />
          </template>
          <span>产品交接</span>
          <router-link to="/factory/transfer-product" />
        </a-menu-item>
